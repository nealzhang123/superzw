<div class="container-fluid"> 
  <div class="row">
    <form method="post" style="margin-bottom:5px;" class="form-search pull-left">
      ...
      <button class="btn btn-small exec_search" type="button"><i class="glyphicon glyphicon-search"></i>&nbsp;搜索</button>
  ...
  <div id="tool_laber" style="margin-top:2px;padding-top:5px;margin-bottom:5px;border-top:2px solid #0088CC;">
    <div style="margin-bottom:5px;" class="pull-left">
      <a class="btn btn-small btn-primary" href="<?php echo admin_url('admin.php?page=crm_send&model='.$this->model); ?>"><i class="glyphicon glyphicon-plus"></i> 新增</a>
