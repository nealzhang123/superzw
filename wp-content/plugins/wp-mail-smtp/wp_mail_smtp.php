...
<form method="POST" action="options-general.php?page=wp_mail_smtp_plugins">
...
function wp_mail_smtp_menus() {
	...
	if (function_exists('add_submenu_page')) {
		add_options_page(__('Advanced Email Options', 'wp_mail_smtp'),__('Email', 'wp_mail_smtp'),'manage_options','wp_mail_smtp_plugins','wp_mail_smtp_options_page');
	}
