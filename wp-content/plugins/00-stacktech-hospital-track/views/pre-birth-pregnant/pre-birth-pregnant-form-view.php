...
<input type="hidden" name="hos_pregnant_id" id="hos_pregnant_id" value="<?php echo $data['item']['id']?>"/>
...
<table class="table table-bordered table-hover table-consdened">
  <tr>
    <td><b>队列编号1 : </b></td>
    <td><input name="hos_pregnant_no1" id="hos_pregnant_no1" type="text" readonly="readonly" value="<?php echo $data['item']['no1']; ?>"/></td>
  </tr>
  <tr>
    <td><b>母亲姓名 : </b></td>
    <td><input name="hos_pregnant_name" id="hos_pregnant_name" type="text" readonly="readonly" value="<?php echo $data['item']['name']; ?>"/></td>
  </tr>
  <?php $lmp_time =date('Y-m-d' ,strtotime($data['item']['lmp'])); ?>
  <tr>
    <td><b>末次月经 : </b></td>
    <td><input type="text" name="hos_pregnant_lmp"  id="hos_pregnant_lmp" value="<?php echo $lmp_time; ?>"></td>
  </tr>
  <?php $days=abs((strtotime(date("Y-m-d 12:00:00"))-strtotime($data['item']['lmp']))/86400); ?>
  <tr>
    <td><b>母亲电话 : </b></td>
    <td><input name="hos_pregnant_pphone" type="text" id="hos_pregnant_pphone" value="<?php echo $data['item']['pphone']; ?>" /></td>
  </tr>
  <tr>
    <td><b>父亲电话 : </b></td>
    <td><input name="hos_pregnant_hphone" type="text" id="hos_pregnant_hphone" value="<?php echo $data['item']['hphone']; ?>" /></td>
  </tr>


	<tr>(温馨提示：1表示有，0表示没有)</tr>
	<?php 
		foreach( $data['pregnant_options_arr'] as $key => $option ){
	?>
		<tr>
			<td><b><?php echo $this->pregnant_arr[$option]; ?> : </b></td>
			<td>
				<label class="radio-inline">
					<input type="radio" value="0" class="hos_pregnant_<?php echo $option; ?>" name="hos_pregnant_<?php echo $option; ?>" <?php if(0 == $data['item'][$option]) echo 'checked="checked"';?> />0
				</label>
				<label class="radio-inline">
					<input type="radio" value="1" class="hos_pregnant_<?php echo $option; ?>" name="hos_pregnant_<?php echo $option; ?>" <?php if(1 == $data['item'][$option]) echo 'checked="checked"';?> />1
				</label>
			</td>
		<tr>
	<?php
 ...
 -->
  ...
  <tr>
    <td><b>孕中期电话 : </b></td>
    <td><input name="hos_pregnant_fut2" type="text" id="hos_pregnant_fut2" value="<?php echo $data['item']['fut2']?>" /></td>
  </tr>
  <tr>
    <td><b>孕中期电话备注 : </b></td>
    <td>
    	<select name="hos_pregnant_fut2rem" id="hos_pregnant_fut2rem">
	    	<option  value=""> 请选择备注情况</option>

    		<?php foreach($this->pregnant_fut2rem_arr as $item ){
  ...
  <tr>
    <td><b>孕中期电话人 : </b></td>
    <td><input name="hos_pregnant_fut2er" type="text" id="hos_pregnant_fut2er" value="<?php echo $data['item']['fut2er']?>" /></td>
  </tr>
